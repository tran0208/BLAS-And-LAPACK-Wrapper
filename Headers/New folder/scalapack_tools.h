...
extern "C" void   pselset_( float *A, int *ia, int *ja, int *desca, float *alpha);
extern "C" float  pslamch_( int *ictxt, char *cmach);
extern "C" void   pslaset_( char *uplo, int *m, int *n, float *alpha, float *beta, float *A, int *ia, int *ja, int *descA );
extern "C" float  pslange_( char *norm, int *m, int *n, float *A, int *ia, int *ja, int *desca, float *work);
extern "C" void   pslaprnt_(int* M, int* N, float* A, int* ia, int* ja, int* descA, int* irprnt, int* icprnt, char* matrixname, int* outfile, float* WORK, int len_m);
extern "C" void   pslawrite_(char* filename, int* m, int* n, float* A, int* ia, int* ja, int* descA, int* irwrit, int* icwrit, float* work, int name_len );
extern "C" void   pslaread_(char* filename, float* A, int* descA, int* ia, int* ja, float* work, int name_len );
//extern "C" void psmatgen_( int *ictxt, char *aform, char *diag, int *m, int *n, int *mb, int *nb, float *A, int *lda, int *iarow, int *iacol, int *iseed, int *iroff, int *irnum, int *icoff, int *icnum, int *myrow, int *mycol, int *nprow, int *npcol, int aform_len, int diag_len );
//
//------------DOUBLE PRECISION REAL------------------
extern "C" void   pdelset_( double *A, int *ia, int *ja, int *desca, double *alpha);
extern "C" double pdlamch_( int *ictxt, char *cmach);
extern "C" void   pdlaset_( char *uplo, int *m, int *n, double *alpha, double *beta, double *A, int *ia, int *ja, int *descA );
extern "C" double pdlange_( char *norm, int *m, int *n, double *A, int *ia, int *ja, int *desca, double *work);
extern "C" void   pdlacpy_( char *uplo, int *m, int *n, double *a, int *ia, int *ja, int *desca, double *b, int *ib, int *jb, int *descb);
extern "C" void   pdlaprnt_(int* M, int* N, double* A, int* ia, int* ja, int* descA, int* irprnt, int* icprnt, char* matrixname, int* outfile, double* WORK, int len_m);
extern "C" void   pdlawrite_(char* filename, int* m, int* n, double* A, int* ia, int* ja, int* descA, int* irwrit, int* icwrit, double* work, int name_len );
extern "C" void   pdlaread_(char* filename, double* A, int* descA, int* ia, int* ja, double* work, int name_len );
//extern "C" void pdmatgen_( int *ictxt, char *aform, char *diag, int *m, int *n, int *mb, int *nb, double *A, int *lda, int *iarow, int *iacol, int *iseed, int *iroff, int *irnum, int *icoff, int *icnum, int *myrow, int *mycol, int *nprow, int *npcol, int aform_len, int diag_len );
//
//------------------SINGLE PRECISION COMPLEX--------------
extern "C" void   pcelset_( float *A, int *ia, int *ja, int *desca, float *alpha);
extern "C" float  pclamch_( int *ictxt, char *cmach);
extern "C" void   pclaset_( char *uplo, int *m, int *n, float *alpha, float *beta, float *A, int *ia, int *ja, int *descA );
extern "C" float  pclange_( char *norm, int *m, int *n, float *A, int *ia, int *ja, int *desca, float *work);
extern "C" void   pclaprnt_(int* M, int* N, float* A, int* ia, int* ja, int* descA, int* iaprnt, int* icprnt, char* matrixname, int* outfile, float* WORK, int len_m);
extern "C" void   pclawrite_(char* filename, int* m, int* n, float* A, int* ia, int* ja, int* descA, int* irwrit, int* icwrit, float* work, int name_len );
extern "C" void   pclaread_(char* filename, float* A, int* descA, int* ia, int* ja, float* work, int name_len );
//
//------------DOUBLE PRECISION COMPLEX------------------
extern "C" void   pzelset_( double *A, int *ia, int *ja, int *desca, double *alpha);
extern "C" double pzlamch_( int *ictxt, char *cmach);
extern "C" void   pzlaset_( char *uplo, int *m, int *n, double *alpha, double *beta, double *A, int *ia, int *ja, int *descA );
extern "C" double pzlange_( char *norm, int *m, int *n, double *A, int *ia, int *ja, int *desca, double *work);
extern "C" void   pzlacpy_( char *uplo, int *m, int *n, double *a, int *ia, int *ja, int *desca, double *b, int *ib, int *jb, int *descb);
extern "C" void   pzlaprnt_(int* M, int* N, double* A, int* ia, int* ja, int* descA, int* iaprnt, int* icprnt, char* matrixname, int* outfile, double* WORK, int len_m);
...
extern "C" void   pzlaread_(char* filename, double* A, int* descA, int* ia, int* ja, double* work, int name_len );
